...
import library.XCodec2.vq.blocks as blocks
import numpy as np
import torch
...
from library.XCodec2.vq.module import EncoderBlock, ResLSTM, WNConv1d
...
class Codec_oobleck_Transformer(nn.Module):
    ...
    def dilated_unit(self, hidden_dim, dilation):
        return blocks.DilatedConvolutionalUnit(
            ...
            kernel_size=3,
            activation=nn.ReLU,
            normalization=utils.parametrizations.weight_norm)
