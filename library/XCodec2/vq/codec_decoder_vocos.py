...
from library.XCodec2.vq import activations
from library.XCodec2.vq.alias_free_torch import *
from library.XCodec2.vq.bs_roformer5 import TransformerBlock
from library.XCodec2.vq.module import (AdaLayerNorm, ConvNeXtBlock,
                                       DecoderBlock, ResLSTM, WNConv1d)
from library.XCodec2.vq.residual_vq import ResidualVQ
...
class VocosBackbone(Backbone):
    ...
    def __init__(self, hidden_dim=1024, depth=12, heads=16, pos_meb_dim=64):
        ...
        self.embed = nn.Conv1d(hidden_dim,
                               hidden_dim,
                               kernel_size=7,
                               padding=3)
...
class CodecDecoderVocos(nn.Module):
    ...
    def __init__(
        ...
        self.quantizer = ResidualFSQ(dim=vq_dim,
        ...
        self.backbone = VocosBackbone(hidden_dim=hidden_dim,
                                      depth=depth,
                                      heads=heads,
                                      pos_meb_dim=pos_meb_dim)

        self.head = ISTFTHead(dim=hidden_dim,
...
class CodecDecoderVocos_transpose(nn.Module):
    ...
    def __init__(
        ...
        self.inverse_mel_conv = nn.Sequential(
            ...
            nn.GELU(),
            nn.ConvTranspose1d(in_channels=hidden_dim,
                               out_channels=hidden_dim,
                               kernel_size=3,
                               padding=1))
...
def main():
    ...
    dummy_input = torch.randn(batch_size, in_channels,
